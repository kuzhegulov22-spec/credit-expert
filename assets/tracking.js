...
window.FUNNEL_CONFIG = {
  ...
  // === TELEGRAM ===
  // Публичный webhook URL Pipedream-workflow (HTTP trigger -> Telegram Send Message).
  // Bot token хранится в Pipedream, НЕ здесь и НЕ в браузере.
  telegramWebhookUrl: 'https://eout3r0rting1xh.m.pipedream.net',
